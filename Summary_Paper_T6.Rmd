...
# **The Attraction of This Dataset**
We chose this topic for a combination of personal interest and the potential for valuable insights. First and foremost, our team shares a genuine passion for coffee. Beyond that, we were drawn to this dataset because it encompasses comprehensive information, including offers sent to customers, demographic data, customer responses, and transactions. Starbucks, being a prominent player in the current market, piqued our curiosity. Through this project, we aimed to gain genuine insights into Starbucks' strategies concerning offers and customer interactions, with the ultimate goal of understanding the key factors driving their business success.

# **Dataset Limitations and Evolving SMART Questions**
The dataset's primary limitation lies in the substantial data loss incurred during the merging of all three datasets, which hindered the feasibility of a reliable exploratory data analysis (EDA). The SMART questions we formulated emerged following a thorough review of the dataset, coupled with extensive brainstorming sessions considering the business context. Post-EDA, we found it necessary to modify a few questions, as some of the initial inquiries required complex model-building approaches for resolution. As a result, we refocused our questions to emphasize EDA-based insights, acknowledging that certain queries revealed no discernible trends during the exploratory phase.
...
The methods employed in this analysis included removing rows with missing data, providing user-friendly aliases for the offers column to improve clarity, converting date and time columns to "days_elapsed" for easier interpretation, and breaking down dictionary elements into separate key and value columns to simplify data manipulation.
...
1. The dataset has 138,953 transactions, over four times completed offers, implying strong customer loyalty due to frequent purchases despite no offer influence, which aligns with Starbucks' focus on fast-moving consumer goods.

2. In the campaign month, 76,277 offers were sent, with 76% viewed, showing effective design and customer engagement.

3. 33,579 offers completed (58% of viewed, 44% of all sent), indicating strong customer loyalty and regular participation in Starbucks' promotions.
...
**OBSERVATION:** 
The plot shows six peaks of campaign events, mainly related to offer reception, followed by offer views, completions, and purchases.
...
The initial graph shows a consistent increase in customer retention rates among those who used the offer only once. This suggests that these customers not only enjoy the offers but also have the potential to become repeat customers, likely enticed by the offer initially and increasingly satisfied with Starbucks.

The second graph reveals a similar positive trend in customer retention rates, but this time among customers who have made multiple purchases using the offer. This signifies a loyal customer base that consistently values and benefits from the offers, indicating trust and satisfaction, which are valuable for Starbucks.

However, it's essential to remember that this analysis focuses on the campaign's duration. To improve long-term customer retention, Starbucks should target customers less likely to return. Identifying and addressing their needs may require a more personalized approach, extended engagement strategies, or innovative incentives to ensure continued patronage beyond the campaign.
...
### Q4. Which age groups are morelikely to accept offers thanothers? Do thesepreferences also differbased on gender?
```{r}
...
Through the analysis of SMART questions, we have uncovered vital insights: the customer base predominantly comprises males, aged 46-75 frequent cafes, and has a diverse income range. BOGO and discount offers are the most popular, while informational offers lag. Men engage the most, with a slight lead over women. The delay in offer engagement does not significantly affect conversion rates. Promotional channel, offer type, and gender all impact offer views. Notably, 'discount' offers are preferred over 'BOGO' offerings, and social media is the most effective promotional channel. These findings provide a holistic view of the customer base and offer preferences, offering valuable guidance for Starbucks' strategic decisions. Considering these insights, our future endeavors will involve constructing predictive models to further enhance our understanding of customer behavior and assist Starbucks in refining their marketing strategies and customer engagement efforts.
...
2. Wu, H. C. (2017). What drives experiential loyalty? A case study of Starbucks coffee chain in Taiwan. *British Food Journal*, 119(3), 468-496.